...
const RegisterForm: React.FC = () => {
  ...
  return (
    <form
      ...
      className="border-2 rounded-2xl border-green-500 max-w-[650px] w-full p-2 md:p-5 space-y-2 bg-green-100"
    >
      <div className="flex flex-col">
        ...
        <input
          className="bg-green-300/60 px-2 rounded-md focus:outline-green-700"
          id="name"
          {...register('name')}
        />
        {errors.name && (
      ...
      <button
        className="w-full h-10 bg-green-600 text-white font-bold"
        type="submit"
      >
        Enviar
      </button>
