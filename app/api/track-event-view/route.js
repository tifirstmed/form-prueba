  ...
  try {
    ...
    const commonEventData = {
      ...
      user_data: {
        ...
        em: crypto.createHash("sha256").update("").digest("hex"),
        ph: crypto.createHash("sha256").update("").digest("hex"),
        fn: crypto.createHash("sha256").update("").digest("hex"),
      },
    ...
    const events = [
      ...
      {
        ...commonEventData,
        event_name: "ViewContent", // Ver Contenido
      },
    ];
